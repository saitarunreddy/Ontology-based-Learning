#This library is downloaded from online source and modified a little to use in my project
#I have no copyrights of it and used it ony for educational purposes
#source to original library: "https://bitbucket.org/yunazzang/aiwiththebest_byor"
#Pharse2Vec and similarity score of two phrases#
...
pathToBinVectors = '/Users/tarun/Desktop/untitled/pizza.model'

model1 = Word2Vec.load(pathToBinVectors)
...
def phrase_similarity(userInput1,userInput2):
